...
label1 = tk.Label(root, text='Sign Language Recognition')
canvas1.create_window(250, 50, window=label1)

#Add button in GUI
button3 = tk.Button (root, text='Detect Sign',command=capture, bg='orange') # button to call the 'values' command above
